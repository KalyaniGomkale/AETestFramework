...
public class InformationPageTU extends TestBase{
	...
	public InformationPageTU() {
		PageFactory.initElements(driver, this);
	}
	public void validateLastLoginTU(String UserName,String Pswd,String Newpassword) throws Exception{
	...
	public void validateViewProfileTU() throws Exception{
		loginpageta.login(prop.getProperty("username_TU1"), prop.getProperty("password_TU1"));
	...
	public void validateAboutTabTU() throws Exception{
		loginpageta.login(prop.getProperty("username_TU1"), prop.getProperty("password_TU1"));
		Reporter.log("User log in successfully",true);
		Thread.sleep(5000);
		wait.until(ExpectedConditions.visibilityOf(UserNameTab));
	...
	public void validateChangePasswordTU(String TAUser,String OldPswd,String NewPswd,String CnfPswd) throws Exception{
