...
public class InformationPageUA extends TestBase{
	...
	public InformationPageUA() {
		PageFactory.initElements(driver, this);
	}

	public void validateLastLoginUA(String uName,String FT_password,String password) throws Exception{
		//tenantuserspageta.valiateCreatingTenantUser(userType, FName, LName, UserMail, UserName, Pswd, ConfirmPswd, RoleName);
		loginpageta.ValidateFirstTimeLogin(uName, FT_password, password);
	...
	public void validateViewProfileUA() throws Exception{
		loginpageta.login(prop.getProperty("username_UA"), prop.getProperty("password_UA"));
	...
	public void validateAboutTabUA() throws Exception{
		loginpageta.login(prop.getProperty("username_UA"), prop.getProperty("password_UA"));
		Reporter.log("User log in successfully",true);
		Thread.sleep(5000);
		wait.until(ExpectedConditions.visibilityOf(UserNameTab));
	...
	public void validateChangePasswordUA(String UAUser,String OldPswd,String NewPswd,String CnfPswd) throws Exception{
		loginpageta.login(UAUser,OldPswd);
		Reporter.log("User log in successfully",true);
		Thread.sleep(5000);
		wait.until(ExpectedConditions.visibilityOf(UserNameTab));
		JavascriptExecutor js1 = (JavascriptExecutor) driver;
