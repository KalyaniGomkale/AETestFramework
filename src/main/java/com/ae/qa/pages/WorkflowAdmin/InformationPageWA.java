...
public class InformationPageWA extends TestBase{
	...
	public InformationPageWA() {
		PageFactory.initElements(driver, this);
	}

	public void validateLastLoginWA(String UserName,String Pswd,String password) throws Exception{
	...
	public void validateViewProfileWA() throws Exception{
		loginpageta.login(prop.getProperty("username_WA"), prop.getProperty("password_WA"));
	...
	public void validateAboutTabWA() throws Exception{
		loginpageta.login(prop.getProperty("username_WA"), prop.getProperty("password_WA"));
		Reporter.log("User log in successfully",true);
		Thread.sleep(5000);
		wait.until(ExpectedConditions.visibilityOf(UserNameTab));
	...
	public void validateChangePasswordWA(String WAAdmin,String OldPswd,String NewPswd,String CnfPswd) throws Exception{
