...
public class PluginsPageAA extends TestBase{
	...
	public PluginsPageAA() {
		PageFactory.initElements(driver, this);
	}
	public void validatePluginStepsAA(String ColumnType,String ComparatorType,String PluginName) throws Exception {
	...
	public void validateWFPluginUtilizationAA(String ColumnType,String ComparatorType,String PluginName) throws Exception {
		loginpageta.login(prop.getProperty("username_AA"), prop.getProperty("password_AA"));
		Reporter.log("User log in Successfully",true);
		// click Plugins Tab
		wait.until(ExpectedConditions.visibilityOf(pluginsTab));
	...
	public void validateSearchFunctionalityPluginAA(String PageSize,String PluginName) throws Exception{
		loginpageta.login(prop.getProperty("username_AA"), prop.getProperty("password_AA"));
		Reporter.log("User log in Successfully", true);
		JavascriptExecutor js_tenant = (JavascriptExecutor) driver;
		js_tenant.executeScript("arguments[0].click();", pluginsTab);
