...
public class InformationPageAA extends TestBase{
	...
	public InformationPageAA() {
		PageFactory.initElements(driver, this);
	}

	public void validateLastLoginAA(String userType, String FName, String LName, String UserMail, String UserName,
	...
	public void validateViewProfileAA() throws Exception{
		loginpageta.login(prop.getProperty("username_AA"), prop.getProperty("password_AA"));
	...
	public void validateAboutTabAA() throws Exception{
		loginpageta.login(prop.getProperty("username_AA"), prop.getProperty("password_AA"));
		Reporter.log("User log in successfully",true);
		Thread.sleep(5000);
		wait.until(ExpectedConditions.visibilityOf(UserNameTab));
	...
	public void validateChangePasswordAA(String AAUser,String OldPswd,String NewPswd,String CnfPswd) throws Exception{
