...
public class AgentSettingsPageTA extends TestBase{
	  ...
	  @FindBy(xpath="//a[text()='Agent Settings']")
	  WebElement AgentSettingsTab;
	  @FindBy(xpath="//div[@class='title-div']/h2")
	  WebElement pageTitle;
	  
	  public AgentSettingsPageTA()
	  {
		  PageFactory.initElements(driver, this);
	  }
	  
		public void validateAgentSettingsPageTA(String PageTitle) throws Exception {
			...
			js.executeScript("arguments[0].click();", AgentSettingsTab);
