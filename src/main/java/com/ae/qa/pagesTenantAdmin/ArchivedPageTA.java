...
public class ArchivedPageTA extends TestBase{
	  ...
	  @FindBy(xpath="//a[text()='Archived']")
	  WebElement archivedTab;
	  @FindBy(xpath="//div[@class='title-div']/h2")
	  WebElement pageTitle;
	  
	  public ArchivedPageTA()
	  {
		  PageFactory.initElements(driver, this);
	  }
	  
		public void validateArchivedPageTA(String PageTitle) throws Exception {
			...
			js.executeScript("arguments[0].click();",archivedTab);
